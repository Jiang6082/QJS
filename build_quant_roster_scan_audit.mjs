...
const scan = JSON.parse(await fs.readFile("quant_internship_roles_scan_v2_raw.json", "utf8"));

const outputJson = "quant_roster_scan_audit.json";
const outputMarkdown = "quant_roster_scan_audit.md";
