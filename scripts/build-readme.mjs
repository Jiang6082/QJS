...
out += 'npm run scan:v2             # single diagnostic scan pass\n';
out += 'npm run scan:all            # run every scanner once\n';
out += '```\n\n';
